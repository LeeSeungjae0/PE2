            ...
            for dir1 in os.listdir(base_directory):
                ...
                for dir12 in os.listdir(dir1_path):
                    ...
                    if os.path.isdir(xml_directory):
                        main(directory0, dir1, dir12, current_directory, data_dict, testsite, graph_image)
    else:
        if directory2.lower() == 'all':
            ...
            if not os.path.isdir(base_directory2):
                ...
                for dir2 in os.listdir(base_directory2):
                    ...
                    if os.path.isdir(xml_directory):
                        main(directory0, directory1, dir2, current_directory, data_dict, testsite, graph_image)
        else:
            main(directory0, directory1, directory2, current_directory, data_dict, testsite, graph_image)

    if xlsx_file:
        output_directory = os.path.join(current_directory, 'res', directory0, 'xlsx')
        os.makedirs(output_directory, exist_ok=True)
        timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')
        xlsx_file_path = os.path.join(output_directory, f'{directory1}_{timestamp}.xlsx')
